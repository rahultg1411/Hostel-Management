            ...
            <main className="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
              ...
              <div className="row my-4">
                <div className="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                  <div className="card">
                    <h5 className="card-header">Number of students</h5>
                    <div className="card-body">
                      <h5 className="font-size card-title">144</h5>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                  <div className="card">
                    <h5 className="card-header">Number of cleaning requets</h5>
                    <div className="card-body">
                      <h5 className="font-size card-title">15</h5>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                  <div className="card">
                    <h5 className="card-header">Number of complaints</h5>
                    <div className="card-body">
                      <h5 className="font-size card-title ">5</h5>
                    </div>
                  </div>
                </div>
              </div>
              <div className="row">
                <div className="col-12 col-xl-12 mb-4 mb-lg-0 ">
                  <div className="card">
                    <h5 className="card-header">Recently added students</h5>
                    <div className="card-body">
